    ...
    <footer>
        <article class="FContainer">
            ...
            <section class="Fright">
                ...
                <img src="https://cdn.pixabay.com/photo/2021/06/15/12/17/instagram-6338401_960_720.png" width="25"
                    height="25" alt="Instagram">
                <img src="https://cdn.icon-icons.com/icons2/1231/PNG/512/1492693505-1-twitter_83571.png"
                    width="25" height="25" alt="Twitter">
                <img src="https://cdn-icons-png.flaticon.com/512/281/281769.png"
                    width="25" height="25" alt="Gmail">
            </section>
        </article>
    </footer>
</template>
